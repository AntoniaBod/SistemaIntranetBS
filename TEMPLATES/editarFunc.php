<?php
// TEMPLATES/editarFunc.php

include_once("../CONFIG/processamento.php"); // Caminho corrigido

// Verifique se o ID do funcionário foi passado pela URL
if (isset($_GET['id_funcionario'])) {
    $id = $_GET['id_funcionario'];
    $funcionario = obterFuncionario($id_funcionario); // Chama a função para obter dados
} else {
...
// Resto do código para editar o funcionário...
?>
